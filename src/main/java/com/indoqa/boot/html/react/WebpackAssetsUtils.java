...
public final class WebpackAssetsUtils {
    ...
    public static void findWebpackAssetsInFilesystem(String assetsFolder, String folder, Consumer<String> setMainCss,
            Consumer<String> setMainJavascript) {
    ...
    public static String getAssetsFolder(String folder, String mountPath) {
